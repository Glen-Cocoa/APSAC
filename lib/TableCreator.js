...
// ADD JSON DATA TO THE TABLE AS ROWS.
        for (var i = 1; i < excelData.length; i++) {
            ...
            for (var j = 0; j < col.length; j++) {
                ...
                } else if(excelData[i][col[j]] == undefined) {
					tabCell.innerHTML = ""
				} else {
...
//append boxes to html file
            ...
            var boxContainer = document.getElementsByClassName('queryboxContainer');
            boxContainer.innerHTML = '';
            boxContainer.appendChild()
*/

$(function(){
	function bootstrap(excelData){
