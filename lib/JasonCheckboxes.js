...
var listLevelsOfStudy = function(){
	for(var i = 0; i < levels_of_study.length; i++){
		levels_of_study_li = $('<div id="'+levels_of_study[i]+'"><input class="clearTarget" type="checkbox" value="'+levels_of_study[i]+'" name="Level of Study Available" id="'+levels_of_study[i]+'"><label for="'+levels_of_study[i]+'">'+levels_of_study[i]+'</label><br></div>')
